        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-12">
              ...
              <form method="POST" action="ajoutEvent.php" class="d-flex align-items-center h-100"  >
<table class="table">
<tr>
<td>ID</td>
...
<td><div id="div" style="color: red;"></div>
  <input type="text" name="nom" id="nom" required pattern ='[A-z]{1,}' oninvalid="setCustomValidity('Veuillez entrer des lettres selement')" 
