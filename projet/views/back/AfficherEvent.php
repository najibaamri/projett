        ...
        <ul class="nav">
          ...
          <li class="nav-item">
            <a class="nav-link" href="pages/charts/chartjs.html">
              <span class="menu-title">Cliens</span>
...
?>
            ...
            <button class="btn btn-gradient-light btn-icon-text btn-sm" >
<?php
  echo "<a id='imprimer' href='' onclick='window.print();return false;'>imprimer </a>";
  ?>
  <i class="mdi mdi-printer btn-icon-append" ></i>
            ...
            <div class="card bg-gradient-success card-img-holder text-white">
             <div class="card-body">
                  ...
                  <h4 class="font-weight-normal mb-3">Nombre de Visiteurs des Evenements
                    <i class="mdi mdi-diamond mdi-24px float-right"></i>
                  </h4>
                  <h2 class="mb-5">
                    <?php  
$f=fopen('../front/compteur.txt', 'c+');
$a=intval(fgets($f));
fclose($f);
echo $a;
 ?></h2>
