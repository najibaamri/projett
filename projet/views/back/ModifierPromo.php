...
<script type="text/javascript">
  ...
  function notify() {
    var notification = new Notification('PROMOTION', {
      icon: '../../notifier.png',
      body: "Hey! Promotion modifiée avec succés!",
...
if (isset($_POST['modifier'])){
  $promo=new Promotion($_POST['id'],$_POST['nom'],$_POST['dateD'],$_POST['dateF'],$_POST['pourcentage'],$_POST['prixAncien'],$_POST['idevent'],$_POST['idproduit']);
  $promoC->modifierPromo($promo,$_POST['id_ini']);
