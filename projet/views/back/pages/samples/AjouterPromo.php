            ...
            <div class="collapse" id="general-pages">
              <ul class="nav flex-column sub-menu">
               <li class="nav-item"> <a class="nav-link" href="AjouterPromo.php"> Ajouter Promotion </a></li>
                <li class="nav-item"> <a class="nav-link" href="ModifierPromo.html"> Modifier Promotion </a></li>
                <li class="nav-item"> <a class="nav-link" href="afficherPromo.php"> afficher Promotion </a></li>
                <li class="nav-item"> <a class="nav-link" href="AjouterEvent.html"> Ajouter Evenement </a></li>
                <li class="nav-item"> <a class="nav-link" href="ModifierEvent.html"> Modifier Evenement </a></li>
                <li class="nav-item"> <a class="nav-link" href="SupprimerEvent.html"> Supprimer Evenement </a></li>
              </div>
          </li>
